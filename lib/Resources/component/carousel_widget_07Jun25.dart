            ...
            if (tempMusaList!.isNotEmpty)
              BlocBuilder<CarouselCubit, List<String>>(
                builder: (context, imageList) {
                  ...
                  //     if (tempMusaList != null &&
                  //         tempMusaList!.isNotEmpty &&
                  //         tempMusaList![index].file != null &&
                  //         tempMusaList![index].file!.isNotEmpty) {
                  //       return InkWell(
                  //         onTap: () {
                  //           Navigator.push(
                  //             context,
                  ...
                  //         },
                  //         child: SizedBox(
                  //           width: 164.w, // Fixed width
                  //           height: 185.h, // Fixed height
                  //           child: Container(
                  ...
                  //                 children: [
                  //                   Positioned.fill(
                  //                     child: Utilities.isVideoUrl(
                  //                             tempMusaList![index]
                  //                                     .file![0]
                  //                                     .fileLink ??
                  //                                 '')
                  //                         ? MusaWidgets.thumbnailView(
                  //                             tempMusaList![index]
                  //                                     .file![0]
                  //                                     .fileLink ??
                  //                                 '')
                  //                         : CachedNetworkImage(
                  //                             imageUrl: tempMusaList![index]
                  //                                     .file![0]
                  //                                     .fileLink ??
                  //                                 '',
                  //                             fit: BoxFit.cover,
