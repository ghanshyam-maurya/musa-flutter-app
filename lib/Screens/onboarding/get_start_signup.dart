...
class GetStartSignUp extends StatefulWidget {
  const GetStartSignUp({super.key});

  @override
  State<GetStartSignUp> createState() => _GetStartSignUpState();
}

class _GetStartSignUpState extends State<GetStartSignUp>
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: Container(
                        decoration: BoxDecoration(
                          // Keep the background solid or transparent since the text is gradient
                        ...
                        //   child: SvgPicture.asset(Assets.textLogo),
                        // ),
                      ),
                    ),
                    const SizedBox(height: 40),
                    ...
                    Padding(
                      ...
                      child: Text(
                        StringConst.createYourAccountForPersonalised,
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          _buildSocialButton(
                            onTap: () {
                              context.push(RouteTo.signupEmail);
                            },
